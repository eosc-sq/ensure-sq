...
%% tox, linting and pipelines, pull requests (github) merge requests (gitlab), the issue trackers, or other helpdesks, pytest, junit, sonarcloud, you name it,

%% and this will be examples of tools and services that can be part of
%% the infrastructure for quality in research software
%% XXXXX Ajouter des définitions de ce dont on parle ??? XXXXXXXXX
...
%% XXXX parler des requêtes de fusion, PR, MR : gestion des
%% collaborations communautaires XXXXXXX
%% Une personne peut contribuer au code en communi-
%% cant un correctif ou une amélioration au projet, soit sous forme de « patch »
%% (fichier contenant les changements apportés), soit en réalisant une requête
%% de fusion des changements (une « pull request », PR, ou « merge request », MR,
