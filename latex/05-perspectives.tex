...
In this section, an \textit{external service provider} (or simply \textit{service provider}) refers to a company or organization that offers services to assist individual researchers and research entities in developing and releasing their research software. 
A service provider may offer either physical resources or software tools and infrastructures.  
...
However, although not every research software project needs to leverage services offered by external service providers, the possibility of relying on such services without worrying about the maintainability of the service itself is undoubtedly an excellent value for research software developers.  
