...
\begin{center}
    ...
    \bottomcaption{Software Quality characteristics are taken from ISO/IEC 25010:2011(E)~\cite{iso_central_secretary_systems_nodate} except Scalability and Supportability.
