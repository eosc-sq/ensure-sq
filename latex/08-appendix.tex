...
\begin{itemize}
    \item The software product's rebuild value is estimated from the number of lines of code. This value is calculated in man-years using the Programming Languages Table of the Software Productivity Research \cite{baggen_standardized_2012}.
\end{itemize}
...
\begin{itemize}
    \item Control measure to counter the confounding effect of class size. The coefficient is calculated by NOTC/NOSC (NOTC = number of test classes, NOSC = number of source classes) \cite{nagappan_early_2005}.
\end{itemize}
...
\textbf{EOSC-Qual-08}: Timeliness: Supportability.
...
\textbf{EOSC-Qual-09}: Cost-Benefit efficiency: Maintainability.
...
\textbf{EOSC-Qual-10}: Accessibility: Technical accessibility.
...
\textbf{EOSC-Qual-11}: Accountability: Performance, Resource utilisation.
...
\textbf{EOSC-Qual-12}: Accuracy: Performance, Functional suitability.

\begin{itemize}
    \item Code outputs are sufficiently precise to satisfy their intended use \cite{boehm_quantitative_1976}.
\end{itemize}

\textbf{EOSC-Qual-13}: Communicativeness: Ease of use.
...
\textbf{EOSC-Qual-17}: Legibility: Supportability, Maintainability.

\begin{itemize}
    \item Software function is easily discerned by reading the code \cite{boehm_quantitative_1976}.
\end{itemize}

\textbf{EOSC-Qual-18}: Modifiability: Modifiability.
...
\textbf{EOSC-Qual-19}: Robustness: Safety.
...
\textbf{EOSC-Qual-20}: Self-containedness: Supportability.

\begin{itemize}
    \item Software performs all its explicit and implicit functions within itself \cite{boehm_quantitative_1976}.
\end{itemize}

\textbf{EOSC-Qual-21}: Self-descriptiveness: Supportability, Ease of use.
...
\textbf{EOSC-Qual-22}: Structuredness: Modifiability, Reusability.

\begin{itemize}
    \item Software possesses a definite pattern of organisation of its interdependent parts \cite{boehm_quantitative_1976}.
\end{itemize}

\textbf{EOSC-Qual-23}: Understandability: Supportability.

\begin{itemize}
    \item Software purpose is clear to the inspector \cite{boehm_quantitative_1976}.
\end{itemize}

\textbf{EOSC-Qual-24}: Intellectual Property: Supportability, Reusability.

\begin{itemize}
    \item There are multiple statements embedded into the software product describing unrestricted rights and any conditions for use, including commercial and non-commercial use, and the recommended citation. The list of developers is embedded in the source code of the product, in the documentation, and in the expression of the software upon execution. The intellectual property rights statements are expressed in legal language, machine-readable code, and in concise statements in language that can be understood by laypersons, such as a pre-written, recognisable licence \cite{shepherdson_cessda_2019}.
\end{itemize}

\textbf{EOSC-Qual-25}: Extensibility: Attractiveness, Modifiability.
...
\textbf{EOSC-Qual-26}: Standards compliance: Functional suitability.

\begin{itemize}
    \item Compliance with open or internationally recognised standards for the software and software development process, is evident and documented, and verified through testing of all components. Ideally independent verification is documented through regular testing and certification from an independent group \cite{shepherdson_cessda_2019}.
\end{itemize}

\textbf{EOSC-Qual-27}: Internationalisation and localisation: Usability.
...
\begin{itemize}
    \item Production-ready code is  built as an artefact that can be installed on a system \cite{shepherdson_cessda_2019,orviz_set_2017,raymond_software_2013}.
\end{itemize}

\textbf{EOSC-SWRelMan-13}: Register/publish artefact: Installability.

\begin{itemize}
    \item The built artefact is uploaded and registered into a public repository of such artefacts \cite{orviz_set_2017}.
\end{itemize}

\textbf{EOSC-SWRelMan-14}: Notification upon registration: Installability.

\begin{itemize}
    \item Upon success of the package delivery process, a notification is sent to predefined parties such as the main developer or team \cite{orviz_set_2017}.
\end{itemize}
...
\begin{itemize}
    \item The Service has an authentication and authorisation mechanism. The Service validates the credentials and signatures \cite{shepherdson_cessda_2019,orviz_fernandez_eosc-synergy_2020}.
\end{itemize}
