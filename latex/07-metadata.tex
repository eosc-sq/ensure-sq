\dg{Daniel is currently working on this section}
...
\dg{maybe move this for an annex? I would like to elaborate on the recommendations that are also being pushed by the community. But that the rlationship with quality is not always one to one. Also, there are existing recommendations and tools to help asswss the fairness. But as for quality, we do this in the next section}
