\subsection{Common recommendations}

\begin{center}
    \tablehead{
        \hline
        \textbf{RS Stack} & \textbf{RS Type} \\
        \hline
    }
    \tabletail{\hline}
    \tablelasttail{\hline}
    ...
    \label{tab:rs_recc00}
    \small
    \begin{supertabular}{|p{0.5\linewidth}|p{0.5\linewidth}|} \hline
    \textbf{All} &
...
\subsection{User story: Individual development}
...
\subsection{User story: Team Project}
...
\subsection{User story: Team OSS}
...
\subsection{User story: Team Service}
