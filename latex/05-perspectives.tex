...
% \mdavid{we should link this with the user stories of section 3}
...
\subsection{Users}
% \mdavid{This is mentioned/discussed in section 4} \miguel{Documentation: how to install, and use the SW. Examples.}
% \mdavid{This should be mentioned/discussed in section 7 FAIR4RS} \miguel{How to cite research SW?}
% \mdavid{This is mentioned/discussed in section 4} \miguel{Is the research SW easy to understand and modify? Is it possible to do so? SW licenses.}
...
% \mdavid{This is mentioned in section 4, and has to do with building packages/artifacts and publish them in a givven public repository of such atifacts} \miguel{Can the SW be put inside a container?}
...
% \mdavid{some of these services are mentioned in section 4, please link with them}
...
% \mdavid{some of these items are mentioned in section 4, please link with them}
